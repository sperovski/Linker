...
@Component({
  ...
  styles: [
    `
      ...
      /* ---------------------------------------------------------------------
         Internship card — 3D depth-on-hover. Scoped to this component only;
         the shared global .card/.badge styles are intentionally not used here.
         Curve + timing shared by the tilt and every parallax layer.
      --------------------------------------------------------------------- */
      .card-wrap {
        position: relative;
        perspective: 1400px;
      ...
      .internship-card {
        ...
        box-shadow: 0 1px 2px rgba(23, 26, 43, 0.05);
      ...
      /* Tilt the whole card. Triggered on the wrapper so hovering the bookmark
         (an overlay sibling of the card) counts, and :focus-within covers
         keyboard focus on either the link or the bookmark. */
      .card-wrap:hover .internship-card,
      .card-wrap:focus-within .internship-card {
        transform: rotate3d(1, -0.35, 0, 6deg) translateY(-6px);
        box-shadow:
          0 24px 44px -20px rgba(23, 26, 43, 0.38),
          0 10px 18px -14px rgba(79, 70, 229, 0.28);
      }
      ...
      /* Parallax layers: flat at rest, lifted toward the viewer on hover. */
      .logo-layer,
      .card-top-text,
      .skill-chips,
      .badges,
      ...
      .card-wrap:hover .logo-layer,
      .card-wrap:focus-within .logo-layer {
        transform: translateZ(40px);
      }

      .card-wrap:hover .card-top-text,
      .card-wrap:focus-within .card-top-text {
        transform: translateZ(28px);
      }

      .card-wrap:hover .skill-chips,
      .card-wrap:focus-within .skill-chips {
        transform: translateZ(18px);
      }

      .card-wrap:hover .badges,
      .card-wrap:focus-within .badges {
        transform: translateZ(14px);
      }

      .card-wrap:hover .card-overlay,
      .card-wrap:focus-within .card-overlay {
        transform: translateZ(44px);
      }

      .logo-layer { display: inline-flex; }
      ...
      /* Card-scoped pill tints (override the global .badge-* for this card). */
      .badges .badge-type { background: #dcebff; color: #2f6df6; }
      .badges .badge-location { background: #f1f1f7; color: #6b7280; }
      .badges .badge-deadline { background: #f1f1f7; color: #6b7280; }
      .badges .badge-deadline-soon { background: #fef3c7; color: #92400e; }
      ...
      .card-wrap:hover .card-cta,
      .card-wrap:focus-within .card-cta {
        opacity: 1;
        transform: translateZ(30px);
      }

      /* Opt-out: no tilt, no parallax, no depth translate — just a flat lift. */
